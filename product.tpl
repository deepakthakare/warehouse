...
<!--Original Code-->
    ...
    <!--end Original Code-->
                            ...
                            <p id="product_reference"{if empty($product->reference) || !$product->reference} style="display: none;"{/if}>
								 ...
								 {if $category->id == 98 || $category->id == 99 || $category->id == 64 || $category->id == 63}
                              ...
                              <p style="text-transform:uppercase;color:#585858">

                                <label>Season : </label>

                             	<span>{$product->custom_field}</span> 
                    ...
                    <form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
                        ...
                        <div class="box-info-product">
                            ...
                            <div class="content_prices clearfix" style="padding-left: 0px; margin-top:-31px;">
                            ...
                            {if $product->description || $packItems|@count > 0}
                                ...
                                {if $product->show_price && !isset($restricted_country_mode) && !$PS_CATALOG_MODE}
                                    ...
                                    <!-- prices -->
                                     ...
                                     {if !$logged}<span ><a href="{$content_dir}login?back=my-account" style="color:#FF0000">Please login/register to view prices. &raquo;</a> </span><br />
                                    ...
                                    <div class="price">
                                        ...
                                        <!--<p>{if $product->wholesale_price}{l s='Wholesale price: '}{$product->wholesale_price|escape:'htmlall':'UTF-8'}€{/if}</p>-->
                                      ...
                                      {* <p class="our_price_display" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                            ...
                                            {if $priceDisplay >= 0 && $priceDisplay <= 2} *}
                                       		...
                                       		{*{l s='PRICE PER PACK  '} &nbsp;&nbsp;<span id="our_price_display" itemprop="price">{convertPrice price=$productPrice}</span>*}
                                          ...
                                          {* {l s='PRICE PER PIECE  '} &nbsp;&nbsp;<span id="our_price_display" itemprop="price">{convertPrice price=$productPrice}</span> 
                                            ...
                                            {if $category->id == 95}{l s=''}

                                            {else}

                                            {l s='PRICE PER PACK '} &nbsp;&nbsp;<span id="our_price_display" itemprop="price">{if $product->wholesale_price}{l s=''} {convertPrice price=$product->wholesale_price} {/if}</span> 
                                ...
                                {*<p id="pQuantityAvailable"{if $product->quantity <= 0} style="display: none;"{/if}>
                                    ...
                                    <span {if ($product->quantity < 11 OR $product->quantity <= 11)}style="display: none"{/if} id="quantityAvailableTxt" > <span style="color:#F00;">{l s='Immediate Delivery'}</span></span>
                                    ...
                                    <span {if ($product->quantity > 10 OR $product->quantity >= 10)} style="display: none"{/if} id="quantityAvailableTxtMultiple"><span style="color:#F00; line-height:25px;">{l s='Immediate Delivery'}</span><br />{l s='Low Stock'}</span>
                            ...
                            <div class="box-cart-bottom">
                              ...
                              {* <div{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
                                   ...
                                   <p id="add_to_cart" class="buttons_bottom_block no-print" style="padding-left: 0px!important; padding-right: 0px!important;">
                                      ...
                                      {if $content_only && (isset($product->customization_required) && $product->customization_required)}
                                        ...
                                        {else} 
                                            ...
                                            <button type="submit" name="Submit" class="add_to_cart_button_new">

                                                <span class="add_to_cart_button_new_span">{l s='ADD To CART'}</span>
					...
					<!-- Description -->
							...
							<section class="page-product-box">
									...
									<h3 class="new_class_heading3" style="padding-left: 0px;">{l s='PRODUCT DESCRIPTION'}</h3>{/if}
									...
									<div  class="description_paragarph" style="padding-left: 0px; border-top: 1px solid #505050; padding-right: 0px;"><p style="font-size: 10px;">{$product->description}</p></div>
...
<h4 style="margin-left:22px;float:left;">{l s='You May Also Like'}</h4>

	



<ul id="bxslider" class="bxslider12">
