                ...
                <div class="product-container" itemscope itemtype="http://schema.org/Product">
                    ...
                    <div class="right-block">
                        ...
                        <p class="product-desc" itemprop="description">
                            <span class="list-desc">{$product.description|strip_tags:'UTF-8'|truncate:360:'...'}</span>
                            <span class="grid-desc">{$product.description|strip_tags:'UTF-8'|truncate:40:'...'}</span>
                        </p>
                  
                      	{if !$logged}<span><a href="{$content_dir}login" style="color:#FF0000">Log-in to view prices. &raquo;</a> </span><br />     
                        		...
                        		<div itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="content_price">
                            		{if isset($product.show_price) && $product.show_price && !isset($restricted_country_mode)}
                                		<span itemprop="price" class="price product-price{if isset($product.specific_prices) && $product.specific_prices && isset($product.specific_prices.reduction) && $product.specific_prices.reduction > 0} product-price-new{/if}">
                                     		{if !$priceDisplay}{convertPrice price=$product.price}{else}{convertPrice price=$product.price_tax_exc} {convertPrice price=$product.getPrice}
                                            {/if}
                               			</span>
