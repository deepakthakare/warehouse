	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="upc">
			<span class="label-tooltip" data-toggle="tooltip"
				...
				{$bullet_common_field} {l s='LM Portal Order ID'}
			</span>
		</label>
		<div class="col-lg-3">
			<input maxlength="30" type="text" id="upc" name="upc" value="{$product->upc|escape:'html':'UTF-8'}" />
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-3" for="upc">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s='Season.'}">
				{$bullet_common_field} {l s='Season'}
			</span>
		</label>
		<div class="col-lg-3">
			<input maxlength="30" type="text" id="lm_season" name="lm_season" value="{$product->lm_season|default:''}" />
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-3" for="upc">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s='Warehouse location.'}">
				{$bullet_common_field} {l s='Location'}
			</span>
		</label>
		<div class="col-lg-3">
			<input maxlength="64" type="text" id="lm_location" name="lm_location" value="{$product->lm_location|default:''}" />
		</div>
	</div>
